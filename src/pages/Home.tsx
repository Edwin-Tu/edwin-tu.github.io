...
import AIAppt from '../images/2026.05.18/Can AI Keep a Script.pdf';
import AIAvideo from '../images/2026.05.18/llm-secret-demo.mp4?url';
                    ...
                    <section id="experience" className="section alt">
                        ...
                        <a href="#/experience/aia-2026" target="_blank" rel="noreferrer" className="exp-item-link">
                            <article className="exp-item">
                                ...
                                <p>
                                    <a href={AIAppt} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()}>PDF</a>
                                    {" | "}
                                    <a href={AIAvideo} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()}>MP4</a>
                                </p>
                            </article>
                        </a>
                    </section>
